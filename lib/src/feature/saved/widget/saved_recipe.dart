...
class SavedRecipe extends StatefulWidget {
  const SavedRecipe({super.key, required this.model, required String image, required String text, required String byName, required double reputation, required int id});
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('${context.lang.by} ${widget.model!.ownerName}',
